    ...
    <section>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Pengajuan Penundaan UKT yang Disetujui</h3>
            </div>
            <div class="card-body">
                <div class="mt-4 table-responsive">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="10" class="text-center">Belum ada data pengajuan Penundaan UKT yang disetujui</td>
                        </tr>
                        @endforelse
                    </tbody>
                    </table>
