    ...
    <section>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Pengajuan Perubahan Kelompok UKT yang Disetujui</h3>
            </div>
            <div class="card-body">
                <div class="mt-4 table-responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Catatan Verifikasi</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->alasan_verif ?? '' }}</td>
                            <td><div class="alert alert-success mb-0">{{ $item->status_ajuan ?? '' }}</div></td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="10" class="text-center">Belum ada data pengajuan Perubahan Kelompok UKT yang disetujui</td>
                        </tr>
                        @endforelse
                    </tbody>
                    </table>
