    ...
    <section>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Pengajuan yang Disetujui Wakil Dekan 2</h3>
            </div>
            <div class="card-body">
                <div class="mt-4 table-responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Hasil Verifikasi Dekan</th>
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="11" class="text-center">Belum ada data pengajuan yang disetujui Dekan</td>
                        </tr>
                        @endforelse
                    </tbody>
                    </table>
