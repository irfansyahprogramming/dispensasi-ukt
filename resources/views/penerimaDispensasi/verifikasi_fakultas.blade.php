    ...
    <section>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Pengajuan yang Diverifikasi Fakultas</h3>
            </div>
            <div class="card-body">
                <div class="mt-4 table-responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Hasil Verifikasi Fakultas</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif ($item->kelayakan == '2')
                                    <span class="badge badge-danger">Tidak Layak</span>
                                @endif
                                @if ($item->alasan_verif)
                                    <br /><small>{{ $item->alasan_verif }}</small>
                                @endif
                            </td>
                            <td><div class="alert alert-success mb-0">{{ $item->status_ajuan ?? '' }}</div></td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="11" class="text-center">Belum ada data pengajuan yang diverifikasi Fakultas</td>
                        </tr>
                        @endforelse
                    </tbody>
                    </table>
