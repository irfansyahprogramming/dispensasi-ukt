    ...
    <section>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Pengajuan yang Disetujui Wakil Rektor 2</h3>
            </div>
            <div class="card-body">
                <div class="mt-4 table-responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Hasil Verifikasi WR2</th>
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="11" class="text-center">Belum ada data pengajuan yang disetujui WR2</td>
                        </tr>
                        @endforelse
                    </tbody>
                    </table>
