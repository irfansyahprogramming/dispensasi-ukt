        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="semester" name="semester">
                                ...
                                @foreach ($listSemester as $sms)
                                    <option value="{{ $sms->semester }}">{{ $sms->semester }} / {{ $sms->des_semester }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="prodi" name="prodi">
                            ...
                            @foreach ($listProdi->isi as $prd)
                                <option value="{{ $prd->kodeProdi }}">{{ $prd->jenjangProdi }} {{ $prd->namaProdi }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="jenis" name="jenis">
                            ...
                            @foreach ($listJenis as $jns)
                                <option value="{{ $jns->id }}">{{ $jns->jenis_dispensasi }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="status" name="status">
                            ...
                            @foreach ($listStatus as $sts)
                                <option value="{{ $sts->id }}">{{ $sts->status_ajuan }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>    
            ...
            <div class="modal-footer py-2">
                <button type="button" class="btn btn-primary" onclick="cetakPenerima()"><i class="fas fa-solid fa-filter"></i> Filter</button>
