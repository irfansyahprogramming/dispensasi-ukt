              ...
              @foreach ($periode as $item)
                <tr>
                  ...
                  <td class="btn-group text-center">
                    <button type="button" data-toggle="tooltip" data-placement="top" title="Edit Data" class="btn btn-sm btn-outline-warning" onclick="editPeriode({{ $item->id }})"><i class="fas fa-edit"></i> </button>
