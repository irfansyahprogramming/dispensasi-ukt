...
<head>
  ...
  <title>Dispensasi UKT | Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="/"><b>Dispensasi UKT </b> Universitas Negeri Jakarta</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">Bila Lupa Password Klik 
        <a href="forgot-password.html">Link ini</a> 
      </p>
      <!--<p class="mb-0">
