        ...
        @elseif (session('user_cmode') == '3')
          ...
          <li class="nav-item" title="Verifikasi Pengajuan Keringanan UKT yang masuk">
            <a href="/verifikasi_dispensasi" class="nav-link {{ $dispen_active }}">
              ...
              <p>
                Data Pengajuan
                <span class="badge bg-danger ml-2 right">{{ $badges->where('id_status_pengajuan', 0)->count('id') == 0 ? '' : $badges->where('id_status_pengajuan', 0)->count('id') }}</span>
              </p>
            </a>
          </li>
        ...
        @elseif (session('user_cmode') == '14')
          <li class="nav-item">
            <a href="/verifikasiDekan_dispensasi" class="nav-link {{ $dispen_active }}">
              <i class="nav-icon fas fa-check"></i>
              <p>
                Verifikasi Dekan <span class="badge bg-danger ml-2 right">{{ $badges->where('id_status_pengajuan', 1)->count('id') == 0 ? '' : $badges->where('id_status_pengajuan', 1)->count('id') }}</span>
                <!--<span class="right badge badge-danger">New</span>-->
              </p>
            </a>
          </li>
        ...
        @elseif (session('user_cmode') == '20')
          ...
          <li class="nav-item">
            <a href="/verifikasiWR2_dispensasi" class="nav-link {{ $dispen_active }}">
              ...
              <p>
                Verifikasi WR II
                <span class="badge bg-danger ml-2 right">{{ $badges->where('id_status_pengajuan', 2)->count('id') == 0 ? '' : $badges->where('id_status_pengajuan', 2)->count('id') }}</span>
                <!--<span class="right badge badge-danger">New</span>-->
              </p>
            </a>
          </li>
