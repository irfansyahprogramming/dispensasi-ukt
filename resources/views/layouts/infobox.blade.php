  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('v_mode',14)->where('jenis_dispensasi', 1)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('v_mode',14)->where('jenis_dispensasi', 5)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('v_mode',14)->where('jenis_dispensasi', 4)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('v_mode',14)->where('jenis_dispensasi', 7)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
</div>
