  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Pengajuan{{ $count_notif ?? 0 }}</span>
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode', 3)->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode', 14)->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode', 20)->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode', 22)->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode', 4)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode',14)->where('id_jenis_dispensasi', 1)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode',14)->where('id_jenis_dispensasi', 5)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode',14)->where('id_jenis_dispensasi', 4)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
  <div class="col-md-3 col-sm-6 col-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $badges->where('mode',14)->where('id_jenis_dispensasi', 7)->where('status_ajuan','1')->count('id') }}</span>
      </div>
    </div>
  </div>
</div>
